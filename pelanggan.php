...
<section>
                ...
                if(isset($_GET['target']))
                {
                    ...
                    elseif($_GET['target']=='profilpelanggan')
                    {
                        require('profilpelanggan.php');
                    }
                    elseif($_GET['target']=='pesan')
                    {
                        require('pesan.php');
                    }
					...
					elseif($_GET['target']=='riwayatpemesanan')
                    {
                        require('riwayatpemesanan.php');
                    }
					elseif($_GET['target']=='editprofilpelanggan')
                    {
                        require('editprofilpelanggan.php');
                    }
                    else
                    {
